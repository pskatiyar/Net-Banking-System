...
<title>Set User id password</title>
<style type="text/css">
<!--
.style1 {
...
<tr>
    <td width="413" height="339" bgcolor="#FFFFFF">
     <fieldset>
      <legend><span class="style23">change uid and password  HERE</span></legend>
      <table width="411" cellpadding="5" align="center">
        <tr>
          <td width="393" height="103" align="center"><p class="style28"><strong>To Activate Your Net banking Please</strong></p>
            <p class="style29">Set your new user id and password</p>    
            
            <span class="style1">
                 <%
try
{
	String p1=request.getParameter("tk1");
	String p2=request.getParameter("tk2");
	String p3=request.getParameter("txtcpass");
    ...
    String q1 ="select nid from user_details";
    String a="active";
    String q2="UPDATE USER_DETAILS SET NID='"+ p1 +"', NPASS='"+ p2 +"', NET_BANKING_ISSUE='"+ a +"'  WHERE ACC_NO='" + accno + "' ";
    ...
    if(c>0)
    {
    out.println("Selected User id  Not Available");	
    
    }
    String z="";
    if(c==0 && p1=="")
    {
    	out.println("Please select an ID");	
    }
    if(c==0 && p2=="")
    {
    	out.println("Please enter password");
    }
    if(c==0 && p2.equals(p3) && !(p2.equals(z)))
    {
    	out.println("Selected User id Available");
...
%>
      ...
      <form id="form1" name="tp" method="post" >
        <p>
          <label><span class="style26"><span class="style27">SELECT USER ID: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span>
          <input type="text" name="tk1" id="tk1" onfocus="up()" size="30" />
          </label>
        </p>
        <p>
          <label><span class="style28">SELECT PASSWORD</span>:&nbsp;&nbsp;
            <input type="password" name="tk2" id="tk2" onfocus="down()" size="30"/>
            </label>
        </p>
        <p><span class="style28">CONFIRM PASSWORD</span>:
          <label>
          <input name="txtcpass" type="password" id="txtcpass" size="30" />
          </label>
        </p>
        <p>
          <label>
        ...
        <p>
          <label></label>
          <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <input type="submit" class="style3" name="btnsubmit" id="btnsubmit" value="CHANGE" onclick="notEmpty(document.getElementById('tk2'), 'Please Enter USER NAME AND PASSWORD')"/>
          </label>
          <label>
      ...
      <span class="style30"><span class="style31">*For better security use the Online Virtual Keyboard </span>.</span> </td>
