        ...
        <td width="681" rowspan="2" bgcolor="#ffffff"><table width="696">
         <tr>
          ...
          <tr>
            ...
            <legend><span class="style3">view beneficiary</span></legend>
            <p>&nbsp;</p>
...
try
{
    ...
    out.print("<tr>");
    out.print("<td bgcolor=#F0F0F0 width=170><span class=style9>ACCOUNT NUMBER</span></td><td bgcolor=#F0F0F0 width=200><span class=style9>NAME OF BENE</span></td><td bgcolor=#F0F0F0 width=160><span class=style9>IFSC CODE</span></td><td bgcolor=#F0F0F0 width=160><span class=style9>TRANS. LIMIT</span></td>");
    out.print("</tr>");
    
   while(rs.next())
    {
        String s1=rs.getString("NAME");
		String s2=rs.getString("ACC");
		
		String s4=rs.getString("IFSC");
		String s5=rs.getString("LIMIT");
 out.print("<tr>");
            out.print("<td bgcolor=#CCCCCC><span class=style1>"+s1+"</span></td><td bgcolor=#CCCCCC><span class=style1>"+s2+"</span></td><td  bgcolor=#CCCCCC><span class=style1>"+s4+"</span></td><td bgcolor=#CCCCCC><span class=style1>"+s5+"</span></td>");
            out.print("</tr>");
        }
        out.print("</table>");
        %>
