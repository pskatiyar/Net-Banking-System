          ...
          <tr>
            <td width="677" height="222"><fieldset>
              ...
              <p>
                ...
                String benn= request.getParameter("radio");
                session.setAttribute("beneficiary", benn);
                String amont = request.getParameter("txtamt");
                session.setAttribute("amount",amont);
                String passs = request.getParameter("txtpass");
...
%>
              ...
              <form id="form1" name="form1" method="post" action="midsecuretransfer.jsp">
                <div align="center">
