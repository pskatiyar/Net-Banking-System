...
<p><br/>
  <br/>
         ...
         <td width="718" bgcolor="#FFFFFF"><form id="form1" name="form1" method="post" action="">
           <h1 class="style6"><span class="style5"> &nbsp;&nbsp;ATM FORM</span></h1>
           ...
           <table width="714" border="0" cellpadding="10">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="radio" name="radio" id="radiomale" value="radiomale" />
male
<input type="radio" name="radio" id="radiofemale" value="radiofemale" />
female</label>
                 <p>
                   <label class="style2">Purpose:</label>
                   <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   <select name="listatm" id="listatm">
                     <option>fresh</option>
                     <option>lost</option>
            ...
            <p>
             ...
             <p class="style2">image</p>
            <label class="style2">Enter Text Shown in Image:<br />
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
            <input type="text" name="txtcatpcha" id="txtcatpcha" />
              </label>
            </p>
             <p>
             <label> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; 
             ...
             <p>&nbsp;</p>
             <p class="style4">* Please insert these values.</p>             </td>
             </tr>
           </table>
                  </form>
         </td>
