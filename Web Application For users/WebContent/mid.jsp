        ...
        <td width="681" rowspan="2" bgcolor="#ffffff"><table width="696">
         <tr>
          ...
          <tr>
            ...
            <legend><span class="style3">delete beneficiary</span></legend>
            <p>&nbsp;</p>
...
int i=0;
	...
	String q1="DELETE FROM BENIFICIARY  where ACC='" + s1+ "' ";
...
System.out.println(s1);
  ...
  <tr>
    <td width="648"><div align="center">
      <p class="style6 style10">PLEAE SELECT AN ACCOUNT NUMBER        </p>
      <p>
        <input name="btndel" type="submit" id="btndel" value="GO BACK" />
        </p>
    </div></td>
  </tr>
</table>
