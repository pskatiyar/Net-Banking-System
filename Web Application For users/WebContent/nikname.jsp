...
.style23 {font-family: Arial, Helvetica, sans-serif; color: #0033FF; }
-->
</style>
        ...
        <td width="681" rowspan="2" bgcolor="#ffffff"><table width="696">
         <tr>
          ...
          <tr>
            ...
            <legend><span class="style3">Set nik name</span></legend>
  
            <p class="style23"> Please Enter nick name as combination of Your name and account number.</p>
            <p class="style23">&nbsp;</p>
            <form id="form1" name="form1" method="post" action="midnick.jsp">
              <table width="342" align="center" cellpadding="5">
                <tr>
                  <td width="163" align="right"><span class="style22">Enter Nick Name:</span></td>
                  <td width="151"><label>
                ...
                <tr>
                  <td colspan="2"><label>
                    <div align="center">
                      <input type="submit" class="style10" name="button" id="button" value="Submit" />
                      </div>
                  </label></td>
                </tr>
              </table>
