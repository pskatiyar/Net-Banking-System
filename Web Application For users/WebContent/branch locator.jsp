...
<tr>
    ...
    <td width="703" bgcolor="#FFFFFF"><table width="556" height="409" cellpadding="25">
      <tr>
        <td width="500" height="403"><p class="style2">BRANCH LOCATOR</p>
          <p class="style5">now you can search our Branch in your area. by following these easy steps</p>
          <table width="527" height="139" cellpadding="15">
            <tr>
              <td width="243" height="133"><form id="form1" name="form1" method="post" action="branch locator.jsp">
		...
		PreparedStatement stmt=conn.prepareStatement("select distinct state from BRANCHLOCATOR");
		...
		while(rs.next())
		{
            ...
            %>
              ...
              <td width="199"><form id="form2" name="form2" method="post" action="branch locator.jsp">
		...
		Connection conn=DriverManager.getConnection("jdbc:odbc:NetBanking","system","vv2339");
		PreparedStatement stmt=conn.prepareStatement("select city from BRANCHLOCATOR where state='" + var1 + "'");
		ResultSet rs=stmt.executeQuery();
		...
		while(rs.next())
		{
          ...
          <table width="526" height="108" cellpadding="5">
            <tr>
              <td width="508" height="102"><fieldset>
              <legend><span class="style9">branch locations</span></legend>
		...
		PreparedStatement stmt1=conn1.prepareStatement("select address1,address2 from BRANCHLOCATOR where city='" + var2 + "'");
