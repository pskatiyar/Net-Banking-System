  ...
  <tr>
   ...
   <tr>
    <td height="72"><table width="952" align="center" cellpadding="8">
      <tr>
        ...
        <td width="681" rowspan="2" bgcolor="#ffffff"><table width="696">
         <tr>
          ...
          <tr>
            <td width="688" height="473"><fieldset>
            <legend><span class="style3">confirmation</span></legend>
            <p>&nbsp;</p>

            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <table width="678" cellpadding="5">
              <tr>
                <td><div align="center" class="style22">Your Beneficiary Request is submitted successfully. After the Approval of bank you can start your fund transfers to all registerd beneficiaries.</div></td>
              </tr>
            </table>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
      ...
      <tr>
        <td height="411" bgcolor="#660033"><table width="217">
          <tr>
