<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="java.sql.* " import="java.io.BufferedReader"
	   ...
	   // private URLConnection sendSMSConnection;
	    ...
	    {  
	     ...
	     /*   if(args.length>0)
	        ...
	        { */
	        String msg2=" ddsv bank"; //msg to be sent
	            phoneNumber.append("9760689618"); /*want to use as bean ??? pass the parametrs for phone,message to send multiple number just insert ';' between them and pass as  a string */
	            phoneNumber.append(';');
