...
try
{	
	String cp1=request.getParameter("textfield");
    ...
    String q2="update USER_DETAILS set ANIK='" + cp1 + "' where ACC_NO='" + accno + "'";
    int i= smt.executeUpdate(q2);
    
    if(i==1)
    {
    
    	 out.println("Account nik name successfully set");
