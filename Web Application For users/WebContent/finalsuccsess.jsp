      ...
      <tr>
        ...
        <tr>
          ...
          <tr>
            ...
            <legend><span class="style3">fund transfered</span></legend>
            <p class="style5" >&nbsp;</p>
            <table width="541" align="center" cellpadding="5">
              <tr>
                <td width="525"><span class="style7">CONGRATULATIONS!! Your fund transfered successfully</span></td>
              </tr>
            </table>
            <p class="style7">&nbsp;</p>
            <p>&nbsp;</p>
