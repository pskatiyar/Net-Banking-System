...
public class Way2Sms {
   // private URLConnection sendSMSConnection;
    ...
    {  
        final String USERNAME="9760689618";//REQUIRED
        final String PASSWORD="420420";//REQUIRED
     ...
     /*   if(args.length>0)
        ...
        { */
        String msg2="to sote sote jawab de rahi ho "; //msg to be sent
            phoneNumber.append("9760266022"); /*want to use as bean ??? pass the parametrs for phone,message to send multiple number just insert ';' between them and pass as  a string */
            phoneNumber.append(';');
